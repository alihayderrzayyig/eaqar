                            ...
                            <td class="px-6 py-4 text-left">
                                <div class="flex float-left space-x-3">
                                    <a href="{{ route('admin.tamlik.edit', $use->id) }}"
                                        class="ml-5 font-medium text-yellow-600 dark:text-blue-500 hover:underline"><svg class="w-6 h-6" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <form action="{{ route('admin.tamlik.destroy', $use->id) }}" method="post"
                                        ...
                                        <button type="submit">                                            <svg class="w-6 h-6 text-red-500" viewBox="0 0 24 24" fill="none"
