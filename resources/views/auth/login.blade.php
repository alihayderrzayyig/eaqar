...
<body class="antialiased bg-indigo-100">
    ...
    <div class="justify-center max-w-4xl min-h-screen p-20 mx-auto">

        <div class="py-8 mb-10 text-center bg-indigo-300 rounded-lg ">
            <h1 class="block mb-6 text-4xl font-medium text-center">مديرية السجيل العقاري في هيت</h1>
            <h3 class="block mt-6 text-2xl text-center ">تسجيل الدخول</h3>
        </div>
